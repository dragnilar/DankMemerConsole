{
    ...
    const apiCall = (apiPath, body, method = "GET") => {
        if (!authHeader)
            throw new Error(
                "The authorization token is missing. Did you forget to set it? `authHeader = 'your_token'`");
    ...
    var api = {
        ...
        sendMessage: (channelId, message, tts, body = {}) => apiCall(`/channels/${channelId}/messages`,
            { content: message, tts: !!tts, ...body },
            "POST"),
        editMessage: (channelId, messageId, newMessage, body =
            {}) => apiCall(`/channels/${channelId}/messages/${messageId}`, { content: newMessage, ...body }, "PATCH"),
        ...
        sendEmbed: (channelId, embed =
            { title: "Title", description: "Description" }) => apiCall(`/channels/${channelId}/messages`,
                { embed },
                "POST"),
        ...
        banUser: (guildId, userId, reason) => apiCall(`/guilds/${guildId}/bans/${userId}`,
        ...
        addRole: (guildId, userId, roleId) => apiCall(`/guilds/${guildId}/members/${userId}/roles/${roleId}`,
            null,
            "PUT"),
        removeRole: (guildId, userId, roleId) => apiCall(`/guilds/${guildId}/members/${userId}/roles/${roleId}`,
            null,
            "DELETE"),
        ...
        listReactions: (channelId, messageId, emojiUrl) => apiCall(
            `/channels/${channelId}/messages/${messageId}/reactions/${emojiUrl}/@me`),
        addReaction: (channelId, messageId, emojiUrl) => apiCall(
            `/channels/${channelId}/messages/${messageId}/reactions/${emojiUrl}/@me`,
            null,
            "PUT"),
        deleteReaction: (channelId, messageId, emojiUrl) => apiCall(
            `/channels/${channelId}/messages/${messageId}/reactions/${emojiUrl}/@me`,
            null,
            "DELETE"),
